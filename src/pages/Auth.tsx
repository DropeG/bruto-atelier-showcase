      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        >
          ...
          <button
            ...
            className="w-full py-3 border border-border rounded text-foreground hover:bg-muted transition-colors flex items-center justify-center gap-3 font-medium"
          >
            <svg
              className="w-5 h-5"
              viewBox="0 0 24 24"
